...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Buzzer_PC =   (Buzzer_PC & \
                                (uint32)(~(uint32)(Buzzer_DRIVE_MODE_IND_MASK << (Buzzer_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Buzzer_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Buzzer__0__SHIFT, mode);
}
