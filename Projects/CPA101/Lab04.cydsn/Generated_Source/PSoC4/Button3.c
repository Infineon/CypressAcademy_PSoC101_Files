...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Button3_PC =   (Button3_PC & \
                                (uint32)(~(uint32)(Button3_DRIVE_MODE_IND_MASK << (Button3_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Button3_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Button3__0__SHIFT, mode);
}
