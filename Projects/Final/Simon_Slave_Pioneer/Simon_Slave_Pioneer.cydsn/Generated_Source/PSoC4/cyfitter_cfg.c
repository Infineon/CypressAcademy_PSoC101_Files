...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x80004B4Cu);

	/* CYDEV_CLK_DIVIDER_B01 Starting address: CYDEV_CLK_DIVIDER_B01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B01), 0x80000C34u);

	/* CYDEV_CLK_DIVIDER_C01 Starting address: CYDEV_CLK_DIVIDER_C01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C01), 0xC00009FFu);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x00303303u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x03000003u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x303000EEu);

		/* UDB_PA_0 Starting address: CYDEV_UDB_PA0_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA0_BASE), 0x00990004u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG4), 0x22000000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x089C0000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x20030000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG4), 0x22000000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x1D000000u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT0_BASE), 0x000000FDu);
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x004B2936u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x00000041u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x00100006u);
	...
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x00CB2024u);
