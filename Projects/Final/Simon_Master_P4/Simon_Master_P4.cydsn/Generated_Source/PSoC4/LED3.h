...
#define LED3_DM_ALG_HIZ         (0x00u << LED3_DRIVE_MODE_SHIFT)
#define LED3_DM_DIG_HIZ         (0x01u << LED3_DRIVE_MODE_SHIFT)
#define LED3_DM_RES_UP          (0x02u << LED3_DRIVE_MODE_SHIFT)
#define LED3_DM_RES_DWN         (0x03u << LED3_DRIVE_MODE_SHIFT)
#define LED3_DM_OD_LO           (0x04u << LED3_DRIVE_MODE_SHIFT)
#define LED3_DM_OD_HI           (0x05u << LED3_DRIVE_MODE_SHIFT)
#define LED3_DM_STRONG          (0x06u << LED3_DRIVE_MODE_SHIFT)
#define LED3_DM_RES_UPDWN       (0x07u << LED3_DRIVE_MODE_SHIFT)
