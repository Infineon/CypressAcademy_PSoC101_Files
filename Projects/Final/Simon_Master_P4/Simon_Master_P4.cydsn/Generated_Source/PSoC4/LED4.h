...
#define LED4_DM_ALG_HIZ         (0x00u << LED4_DRIVE_MODE_SHIFT)
#define LED4_DM_DIG_HIZ         (0x01u << LED4_DRIVE_MODE_SHIFT)
#define LED4_DM_RES_UP          (0x02u << LED4_DRIVE_MODE_SHIFT)
#define LED4_DM_RES_DWN         (0x03u << LED4_DRIVE_MODE_SHIFT)
#define LED4_DM_OD_LO           (0x04u << LED4_DRIVE_MODE_SHIFT)
#define LED4_DM_OD_HI           (0x05u << LED4_DRIVE_MODE_SHIFT)
#define LED4_DM_STRONG          (0x06u << LED4_DRIVE_MODE_SHIFT)
#define LED4_DM_RES_UPDWN       (0x07u << LED4_DRIVE_MODE_SHIFT)
